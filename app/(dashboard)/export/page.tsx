...
export default function ExportPage() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900">Exportar Relatório</h1>
        <p className="text-sm text-gray-500 mt-0.5">Baixe o relatório mensal em CSV ou Excel</p>
      </div>
        ...
        <div className="flex gap-4 mt-4">
          <div className="flex-1">
            ...
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:border-blue-500 capitalize"
            >
              {MESES.map((m) => (
      ...
      <div className="mt-6 bg-gray-50 border border-gray-200 rounded-xl p-4">
        <p className="text-xs text-gray-500 font-medium mb-2">O relatório inclui:</p>
